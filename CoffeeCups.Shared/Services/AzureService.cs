...
namespace CoffeeCups
{
    public class AzureService
    {
        ...
        IMobileServiceSyncTable<itemKopi> coffeeTable;
        ...
        public async Task Initialize()
        {
            ...
            var appUrl = "https://ngopiYuks.azurewebsites.net";
            ...
            coffeeTable = Client.GetSyncTable<itemKopi>();
        ...
        public async Task<IEnumerable<itemKopi>> GetCoffees()
        {
            //Initialize & Sync
            await Initialize();
            await SyncCoffee();
        ...
        public async Task<itemKopi> AddCoffee(bool atHome, string orderName, string orderMenu, string orderLocation)
        {
            await Initialize();

            var coffee = new itemKopi
            {
